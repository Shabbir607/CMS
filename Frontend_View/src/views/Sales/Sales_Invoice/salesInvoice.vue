<template>
    <div class="header">
        <div class="headerinfo">
            ...
            <div class="buttn">
                <router-link to="/salesinvoice/create" type="button" class="btn1"><i class="fa-solid fa-plus"></i>Add
                    New</router-link>
            </div>
        </div>
    </div>
    ...
    <div class="card my-4">
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                <tr v-for="item in salesData.data" :key="item.id">
                    ...
                    <td>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <router-link :to="{ path: '/salesinvoiceView/'+item.id }">
...
export default {
    ...
    methods: {
        async dataFetch(page, filterParams = '') {
            this.loading = ! false;
            try {
                const response = await axios.get(`api/saleinvoice/index?${filterParams}&page=${page}&per_page=${this.itemsPerPage}`);
        ...
        deleteRecord(Id) {
            if (confirm('Are You Sure You Want to Delete This Data')) {
                ...
                axios.delete(`api/saleinvoice/delete/${Id}`)
                    .then(res => {
                        this.dataFetch();
