        ...
        <div class="headerinfo">
            ...
            <div class="buttn">
                <!-- <a type="button" class="btn1" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
                    aria-controls="offcanvasRight"><i class="fa-solid fa-file-import"></i>Import Data</a> -->
                <router-link to="/createcustomer" type="button" class="btn1"><i class="fa-solid fa-plus"></i>Add New
            ...
            <tbody v-else>
                <tr v-for="item in customers.data" :key="item.id">
                    ...
                    <td v-if="item.active === 1">
                        <span
                            style="background-color: rgb(0, 233, 0);padding: 1px 10px; font-size: 12px; border-radius: 2px;">Active</span>
                    </td>
                    <td v-else>
                        <span
                            style="background-color: rgb(198, 220, 0);padding: 1px 10px; font-size: 12px; border-radius: 2px;">UnActive</span>
                    </td>
                    <td>
                        <router-link :to="{ path: '/customer/edit/' + item.id }">
    ...
    <!-- <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div class="col-sm-12 col-md-12 d-flex">
                <button type="button" class="btn btn-added" style="background-color:#9D568A;color:white">
                    Save
                </button>
                <button type="button" class="btn btn-added ml-4" style="background-color:#9D568A;color:white">
                    Download Format
                </button>
            </div>
...
export default {
    ...
    methods: {
        async dataFetch(page) {
            this.loading = ! false;
            try {
                const response = await axios.get(`api/customer?page=${page}&per_page=${this.itemsPerPage}`);
        ...
        deleteRecord(id) {
            if (confirm('Are You Sure You Want to Delete This Data')) {
                ...
                axios.delete(`api/customer_delete/${id}`)
                    .then(res => {
                        this.dataFetch();
