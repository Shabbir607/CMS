<template>
    ...
    <div class="card">
        <div class="card-body">
            <div class="print">
                <span>Quotation Detail: {{ otherDetails.sq }}</span>
                                    ...
                                    <tr>
                                        <td style="width:50%;padding:5px;vertical-align:top;text-align:left;">
                                            <font
                                                ...
                                                To</font><br>
                                            <font v-if="otherDetails.customer"
                                        ...
                                        <td style="width:50%;padding:5px;vertical-align:top;text-align:right;"><!--!--><br>
                                            <font
                                                style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                                Date: {{ otherDetails.date }}</font><!--!--><br>
                                            <font
                                                style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                                Valid Till: {{ otherDetails.expire_date }}</font><br>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <td style="padding-top:10px;">
                                    ...
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;font-size: 15px;color:#000;font-weight: 400;">
                                            {{ otherDetails.terms_conditions }}</font>
                                    </font><br>
                                </td>
                            </tr>
                        </table>
...
export default {
    ...
    methods: {
        async dataFetch() {
            try{
            const response = await axios.get(`api/salequotation/detail/${this.$route.params.id}`);
            ...
            const formattedDate2 = format(new Date(this.otherDetails.expire_date), 'dd-MMM-yyyy');
            this.otherDetails.expire_date = formattedDate2;
            }catch (error) {
