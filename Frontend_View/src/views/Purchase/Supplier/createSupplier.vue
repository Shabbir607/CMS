  ...
  <div class="card mt-3">
    <form class="row" @submit.prevent="addRecord">
      ...
      <div class="col-md-4 mt-4">
        ...
        <input type="number" v-model="formData.balance" class="form-control" id="inputZip">
      </div>
      ...
      <div class="col-12 mt-4">
        ...
        <router-link to="/supplier" class="cancel mx-3">
  ...
  methods: {
    ...
    async addRecord() {
            try {
                ...
                const response = await axios.post('api/supplier_add', formData);
